...
CATEGORY_SEED: list[tuple[str, CategoryKind]] = [
    ...
    ("Insurance", CategoryKind.COMMITTED),
    ("Rent", CategoryKind.COMMITTED),
    ("Utilities", CategoryKind.COMMITTED),
    ("Subscriptions", CategoryKind.COMMITTED),
    ("Loan Payments", CategoryKind.COMMITTED),
    ("Donations", CategoryKind.FLEXIBLE),
    ("Groceries", CategoryKind.FLEXIBLE),
    ("Food and Drinks", CategoryKind.FLEXIBLE),
    ("Transportation", CategoryKind.FLEXIBLE),
    ("Shopping", CategoryKind.FLEXIBLE),
    ("Entertainment", CategoryKind.FLEXIBLE),
    ("Travel", CategoryKind.FLEXIBLE),
    ("Self Care", CategoryKind.FLEXIBLE),
    ("Misc", CategoryKind.FLEXIBLE),
